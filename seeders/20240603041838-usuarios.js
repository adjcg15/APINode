...
module.exports = {
    async up (queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('usuario', [
            { id: crypto.randomUUID(), email: 'adjcg15@gmail.com', passwordhash: await bcrypt.hash('patito', 10), nombre: 'Ángel De la cruz', rolid: AdministradorUUID, protegido: true, createdAt: new Date(), updatedAt: new Date() },
